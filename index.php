...
<div class="wrapper-all">
	<div class="wrapper">
		<div class="left__btn-group">
			<div class="lang">
				<div class="lang__btn-wrap"><a href="" class="lang__btn">РУС</a></div>
				<div class="lang__btn-wrap"><a href="" class="lang__btn">ENG </a></div>
			</div>
			<div id="share" class="share">
				<div class="share__btn-wrap"><a href="" alt="facebook" id="fb-share" class="share__btn share__btn_fb"></a>
					<div class="share__btn-wrap"><a href="" alt="facebook" id="like" class="share__btn share__btn_like"></a></div>
				</div>
		...
		<div class="container cl">
			...
			<div class="controls-bl">
				<h3 class="controls-title">Настройки</h3>
				<form id="form" class="form">
					...
					<div class="form__group">
						<div class="form__group-wrap group-wrap__placement">
							<header class="header__placement">
								<label class="form__label place-title">Положение</label><span class="place-title__change-view">
											<div class="radio">
					...
					<div class="form__group">
						<div class="form__group-wrap group-wrap__transparency">
							<label class="form__label transparency-title">Прозрачность</label>
							<div id="slider">                           </div>
						</div>
					</div>
					<div class="btn__box">
						<button id="reset" type="reset" disabled="disabled" class="btn btn__clear">Сброс</button>
						<button id="submit" type="submit" disabled="disabled" class="btn btn__save">Скачать</button>
					</div>
				</form>
			</div>
		</div>
