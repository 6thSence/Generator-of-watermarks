...
``` js
// Module of data collection for transmission to the server
...
//Module of data transmission to the server for download finished image
...
//Slider’s work module, which  is responsible for clarity of watermark.
...
//Uploading and compresioning of images
var FileUploadJQ = (function(){
  // Uploading and processing of main image
  var _setUpListners = function() {
  ...
  // Uploading and processing of watermark
...
var Coordin = (function () {
  ...
  //Tracing of watermark’s position
  var drag = function(){
  ...
  //Module destroying, handler unbinding
...
//Adding data attribute to squares positioning.
if ($('.choose-position')) {
  $(function () {
...
// Module of switching between modules
var toggelModule = (function(){
  var init = function(){
      _setupListener();
  };
  //Initilization of condition according to default
  var first = function () {
      Coordin.destroy();
      main2.destroy;
      Coordin.init();
  ...
  //Conditions switcher(tiling/ /unary watermark)
  ...
  //Initialization of usual condition
  var _initSingle = function(){
      ...
      Coordin.positionOn();
      $( "#slider" ).slider({'value':100});   };
  //Initialization of tile condition
...
var ShareShow = (function(){
  ...
  var _setUpListners = function() {
      $('.share__btn_like').on('mouseenter', function(){
          $(this).stop(true,true);
          $('.share').addClass('open').animate({left: '0px' });   // Social icons
      });
